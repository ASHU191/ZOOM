...
const product = {
  ...
  gallery: ["/product/p114-1.png?height=300&width=300", "/product/p114-2.png?height=300&width=300" , "/product/p114-3.png?height=300&width=300"],
      ...
      <div className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <ChevronRight className="h-4 w-4 mx-2" />
              <Link href="/products?category=Terminal-Box" className="hover:text-primary-600">  Terminal Box
            </Link>
            <ChevronRight className="h-4 w-4 mx-2" />
