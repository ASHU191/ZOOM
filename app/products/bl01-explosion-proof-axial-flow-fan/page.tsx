...
import { ChevronRight, Star, Shield, Truck, Award, Wind } from "lucide-react"
      ...
      <div className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <ChevronRight className="h-4 w-4 mx-2" />
            <Link href="/products?category=exhaust-fan" className="hover:text-primary-600">
              Exhaust Fan
            </Link>
            <ChevronRight className="h-4 w-4 mx-2" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="flex items-center text-sm">
                  <Wind className="h-5 w-5 text-primary-600 mr-2" />
              ...
              <div>
                ...
                <div className="prose max-w-none">
                  <p className="mb-4 text-sm lg:text-base">
                    The BL01-Series Explosion-proof Axial Flow Fan represents advanced ventilation technology
                    specifically engineered for hazardous industrial environments. This robust ventilation system
                    combines high-performance airflow capabilities with uncompromising explosion-proof safety features
                    to ensure reliable operation in areas where flammable gases or vapors may be present.
                  </p>
                  <p className="mb-4 text-sm lg:text-base">
                    Constructed with explosion-proof motors and corrosion-resistant materials, this axial flow fan is
                    designed to withstand the harsh conditions of industrial environments while providing efficient air
                    circulation. The modular design allows for flexible installation options, including inline duct
                    mounting and pipeline integration.
                  </p>
                  <h3 className="text-lg font-bold mb-3">Ventilation Excellence</h3>
                  <ul className="list-disc pl-5 mb-6 space-y-2 text-sm lg:text-base">
                    <li>High-efficiency explosion-proof motor design</li>
                    <li>Corrosion-resistant construction for longevity</li>
                    <li>Optimized blade design for maximum airflow</li>
                    <li>Flexible installation configurations</li>
                    <li>Low noise operation for workplace comfort</li>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Industrial Ventilation</h3>
                    <p className="text-sm text-gray-600">General ventilation for manufacturing facilities</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Exhaust Systems</h3>
                    <p className="text-sm text-gray-600">Removal of hazardous fumes and vapors</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Pipeline Pressure</h3>
                    <p className="text-sm text-gray-600">Pressure improvement in duct systems</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Chemical Plants</h3>
                    <p className="text-sm text-gray-600">Safe ventilation in chemical processing areas</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Oil & Gas</h3>
                    <p className="text-sm text-gray-600">Ventilation for refineries and processing units</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Mining Operations</h3>
                    <p className="text-sm text-gray-600">Underground and surface mining ventilation</p>
                  </div>
                </div>
              </div>
            )}
