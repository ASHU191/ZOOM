...
const product = {
 ...
 id: 101,
  ...
  image: "/placeholder.svg?height=200&width=250",
      gallery: ["/product/p101-1.png?height=300&width=300", "/product/p101-2.png?height=300&width=300"],
      ...
      <div className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <ChevronRight className="h-4 w-4 mx-2" />
              <Link href="/products?category=Pipe-Fittings" className="hover:text-primary-600">  Pipe Fittings
            </Link>
            <ChevronRight className="h-4 w-4 mx-2" />
