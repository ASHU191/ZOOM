...
const product = {
  id: 7,
    ...
    gallery: ["/product/p7-1.jpeg?height=300&width=300", "/product/p7-2.jpeg?height=300&width=300"],
    features: [
      ...
      <div className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <ChevronRight className="h-4 w-4 mx-2" />
            <Link href="/products" className="hover:text-primary-600">              Circuit Breakers
            </Link>
            <ChevronRight className="h-4 w-4 mx-2" />
