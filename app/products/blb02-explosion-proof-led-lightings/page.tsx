              ...
              <div>
                ...
                <div className="prose max-w-none">
                  <p className="mb-4 text-sm lg:text-base">
                    The BLB02-Series represents advanced explosion-proof lighting technology designed specifically for
                    high-intensity applications in hazardous environments. These powerful LED lighting solutions combine
                    spotlight and floodlight capabilities with robust explosion-proof construction to deliver superior
                    illumination where safety and performance are critical.
                  </p>
                  <p className="mb-4 text-sm lg:text-base">
                    With power options ranging from 130W to 280W, these lights are engineered for demanding industrial
                    applications requiring high-intensity illumination. The adjustable bracket system allows for precise
                    beam positioning, while the separate cavity design ensures optimal thermal management and simplified
                    maintenance procedures.
                  </p>
                  <h3 className="text-lg font-bold mb-3">High-Performance Features</h3>
                  <ul className="list-disc pl-5 mb-6 space-y-2 text-sm lg:text-base">
                    <li>High-power LED technology for maximum light output</li>
                    <li>Dual configuration: Spotlight and Floodlight options</li>
                    <li>Adjustable mounting bracket for precise beam control</li>
                    <li>Corrosion-resistant housing for harsh environments</li>
                    <li>Separate electrical and wiring cavities for safety</li>
                    <li>Optional protective grid for additional protection</li>
                  </ul>
                </div>
              </div>
            )}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Large Area Illumination</h3>
                    <p className="text-sm text-gray-600">
                      Industrial yards, loading docks, and large manufacturing facilities
                    </p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Spotlight Applications</h3>
                    <p className="text-sm text-gray-600">Focused lighting for specific work areas and equipment</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Floodlight Applications</h3>
                    <p className="text-sm text-gray-600">
                      Wide-area coverage for perimeter security and general lighting
                    </p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Petrochemical</h3>
                    <p className="text-sm text-gray-600">Refineries, tank farms, and processing units</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Marine Applications</h3>
                    <p className="text-sm text-gray-600">Offshore platforms, ship decks, and marine terminals</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Mining Operations</h3>
                    <p className="text-sm text-gray-600">Surface mining, processing facilities, and equipment areas</p>
                  </div>
                </div>
              </div>
            )}
