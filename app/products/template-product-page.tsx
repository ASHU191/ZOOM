...
// Template for creating new product pages
// Copy this file and replace the product data with actual product information
...
const product = {
  ...
  description: "Product description goes here...", // Replace with actual description
  ...
  price: "0,000", // Replace with actual price
  originalPrice: "0,000", // Replace with actual original price
  availability: "IN STOCK",
  sku: "PRODUCT-SKU", // Replace with actual SKU
  rating: 4.5,
  reviews: 10,
}
            ...
            {activeTab === "description" && (
              <div>
                ...
                <div className="prose max-w-none">
                  <p className="mb-4 text-sm lg:text-base">{product.description}</p>
                  <p className="mb-4 text-sm lg:text-base">
                    This product is designed with safety and reliability in mind, meeting all necessary industry
                    standards for hazardous area applications. The robust construction ensures long-lasting performance
                  ...
                  <ul className="list-disc pl-5 mb-6 space-y-2 text-sm lg:text-base">
                    <li>Certified for use in hazardous areas</li>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <p className="text-sm text-gray-600">Refineries, drilling platforms, and processing facilities</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Chemical Industry</h3>
                    <p className="text-sm text-gray-600">Chemical processing plants and storage facilities</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Mining</h3>
                    <p className="text-sm text-gray-600">Underground mines and mineral processing facilities</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Pharmaceuticals</h3>
                    <p className="text-sm text-gray-600">Manufacturing facilities and research laboratories</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold mb-3">Food Processing</h3>
                    <p className="text-sm text-gray-600">Processing plants and packaging facilities</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm">
