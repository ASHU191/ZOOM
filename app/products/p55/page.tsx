...
const product = {
  id: 55,
    ...
    gallery: ["/product/p55-1.png?height=300&width=300", "/product/p55-2.png?height=300&width=300" , "/product/p55-3.png?height=300&width=300"],
    features: [
      ...
      <div className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <ChevronRight className="h-4 w-4 mx-2" />
            <Link href="/products?category=exhaust-fan" className="hover:text-primary-600">  Exhaust Fan
            </Link>
            <ChevronRight className="h-4 w-4 mx-2" />
